...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "street":"SAMPLE_TEXT", "neighbourhood":"SAMPLE_TEXT", "number":"SAMPLE_TEXT", "complement":"SAMPLE_TEXT", "code":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "isPrincipal":null}""")).asJSON
            .check(status.is(201))
