...
public class AddressResourceIntTest {
    ...
    private static final String DEFAULT_NEIGHBOURHOOD = "AAAAAAAAAA";
    private static final String UPDATED_NEIGHBOURHOOD = "BBBBBBBBBB";
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getNeighbourhood()).isEqualTo(DEFAULT_NEIGHBOURHOOD);
        ...
        assertThat(testAddress.isIsPrincipal()).isEqualTo(DEFAULT_IS_PRINCIPAL);
    }
    ...
    @Test
    @Transactional
    public void checkNeighbourhoodIsRequired() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
        address.setNeighbourhood(null);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].neighbourhood").value(hasItem(DEFAULT_NEIGHBOURHOOD.toString())))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.neighbourhood").value(DEFAULT_NEIGHBOURHOOD.toString()))
    ...
    public void updateAddress() throws Exception {
        ...
        updatedAddress
            ...
            .neighbourhood(UPDATED_NEIGHBOURHOOD)
        ...
        assertThat(testAddress.getNeighbourhood()).isEqualTo(UPDATED_NEIGHBOURHOOD);
        ...
        assertThat(testAddress.isIsPrincipal()).isEqualTo(UPDATED_IS_PRINCIPAL);
    }
