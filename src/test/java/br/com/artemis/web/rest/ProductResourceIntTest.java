...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPriceValue()).isEqualTo(DEFAULT_PRICE_VALUE);
    }
    ...
    @Test
    @Transactional
    public void checkPriceValueIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setPriceValue(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].priceValue").value(hasItem(DEFAULT_PRICE_VALUE.intValue())));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.priceValue").value(DEFAULT_PRICE_VALUE.intValue()));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPriceValue()).isEqualTo(UPDATED_PRICE_VALUE);
    }
